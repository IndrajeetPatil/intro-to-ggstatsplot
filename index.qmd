...
(Or why did a social psychologist get into software development?)
:::
...
:::{style="background-color: #FFDCA9; padding: 20px; margin: 20px; border-radius: 25px; text-align: center;"}
...
:::{style="background-color: #FDE7BB; padding: 20px; margin: 20px; border-radius: 25px; text-align: center;"}
...
[Training material](https://sites.google.com/site/indrajeetspatilmorality/presentations){target='_blank'} on best practices in software/package development to support community contributions.
